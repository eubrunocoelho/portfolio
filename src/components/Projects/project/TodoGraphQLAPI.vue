<template>
    <div class="project-cover project_cover_reveal">
        <img src="../../../assets/img/projects/todo-graphql.png" />
    </div>
    <div class="about">
        <h1 class="title project_title_reveal">Todo GraphQL API</h1>
        <p class="text project_text_languages_reveal">
            API de pendências onde elas estão disponibilizadas apenas para seus próprios usuários, contando também com
            um sistema de autenticação JWT para garantir a segurança dos dados. (Projeto Pessoal)
        </p>
